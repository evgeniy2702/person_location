...
(function () {
    ...
    buttonDesc.style.pointerEvents = null;
    buttonAsc.style.pointerEvents = "none";

    if(person_list.length === 1){
        buttonDesc.style.pointerEvents = "none";
        buttonAsc.style.pointerEvents = "none";
    }

    start = 0;

    if(person_list.length <= 20)
