// LISTING PERSONS ON PAGE BY 50 ROWS ON CLICK

let div = document.getElementById("footer");

let buttonMinusNew = "<a id='buttonMinus' class='btn btn-outline-success' href='#' style='pointer-events: none;'> - 20 </a>";
let buttonMinusNewTag = document.createElement("a");
buttonMinusNewTag.innerHTML = buttonMinusNew;
div.replaceChild(buttonMinusNewTag, div.children[0]);

let buttonPlusNew = "<a id='buttonPlus' class='btn btn-outline-success' href='#' > + 20 </a>";
let buttonPlusNewTag = document.createElement("a");
buttonPlusNewTag.innerHTML = buttonPlusNew;
div.replaceChild(buttonPlusNewTag, div.children[2]);
...
buttonPlus.onclick = function () {
    ...
    buttonMinus.removeAttribute("style");
    ...
    if(end < person_list.length ){
        ...
        for (let i = start; i <= end; i++) {
            ...
            let trString = "<tr class='pl-md-5' scope='row'><" +
                ...
                "</th>" +
                "<td>" + person_list[i].last_modified + "</td>" +
                "</tr>";
...
buttonMinus.onclick = function () {
    ...
    buttonPlus.removeAttribute("style");
    ...
    if(start >= 0) {
     ...
     if(start <= 0){
         buttonMinus.setAttribute("style", "pointer-events: none;");
     }
